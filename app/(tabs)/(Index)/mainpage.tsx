...
const fortuneMessages = [
  "당신은 지금 이 순간에도 충분히 잘 버티고 있어요.",
  "어둠이 깊을수록 별빛은 더 밝게 빛납니다.",
  "괜찮지 않아도 괜찮아요. 그 자체로 의미가 있어요.",
  "오늘의 작은 성취가 내일의 큰 기쁨이 될 거예요.",
  "오늘의 힘듦이 내일의 당신을 더 강하게 만들 거예요.",
  "당신은 혼자가 아니며, 많은 이들이 당신을 응원하고 있어요.",
  "감정은 지나가는 구름과 같으니 너무 오래 붙잡지 마세요.",
  "마음이 지칠 땐 잠시 쉬어가도 괜찮아요.",
  "희망은 언제나 가까이에 있으니 포기하지 말아요.",
  "당신의 이야기는 아직 끝나지 않았어요. 계속 써 내려가세요.",
  "오늘도 당신의 용기에 박수를 보냅니다.",
  "작은 친절이 큰 변화를 만듭니다. 오늘도 누군가에게 친절을 베풀어 보세요.",
  "당신의 감정은 당신의 강점입니다. 솔직해져도 괜찮아요.",
  "오늘 하루, 자신에게 작은 선물을 해보세요.",
  "당신의 존재 자체가 이미 소중한 가치입니다."
];
