...
import { Alert, DeviceEventEmitter, Dimensions, Image, ScrollView, StyleSheet, Text, TouchableOpacity, View } from "react-native";
    ...
    if (isLoggedIn && role !== 'ADMIN') {
      Promise.all([
        ...
        .then(([postsRes, likesRes, bookmarksRes, cardRes]) => {
          ...
          //북마크 목록 커뮤니티, 카드뉴스 분리 후 각각 최신순 정렬
